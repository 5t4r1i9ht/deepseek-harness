...
export const zh = {
  ...
  'stats.tokensPerSecond': 'TPS {throughput}',
  'stats.cacheHit': '缓存命中 {percent}%',
  'stats.tokens': '输入 {input} tok · 输出 {output} tok',
  'stats.tokensDetailed': '输入 hit {hit} · miss {miss} · 输出 {output}',
  'stats.context': '上下文 {used} / {total} · {percent}%',
  'details.title': '详情',
  'details.close': '关闭详情',
...
export const en = {
  ...
  'stats.tokensDetailed': 'Hit {hit} · Miss {miss} · Output {output}',
  'stats.context': 'Context {used} / {total} · {percent}%',
